...
(function ($, window, document, undefined) {
	...
	var MessageBox = {
		...
		getImageUrl: function () {
			...
			if (type === 'question')
				return imagePath + 'mb_question.png';

			if (type === 'warning' || type === 'alert')
				return imagePath + 'mb_warning.png';

			if (type === 'stop')
				return imagePath + 'mb_stop.png';

			return imagePath + 'mb_information.png';
		},
		...
		getDialogContent: function () {
            ...
            var imageClass = this.getImageClass();
			var content = self.content;

			var dialogView = "<div style='height:15px;'></div>";
				dialogView += "<div style='float:left;padding-left:5px;' class='"+imageClass+"'>";
